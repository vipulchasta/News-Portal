...
@Component({
    selector: 'app-manage-news-admin',
    templateUrl: './manage-news-admin.component.html',
    styleUrls: ['./manage-news-admin.component.css'],
})
export class ManageNewsAdminComponent implements OnInit {
    newsList: any = [];
    fileToUpload: File;
    totalRecords: number;
    page: number = 1;
