...
@Component({
    selector: 'app-news-list-admin-screen',
    templateUrl: './news-list-admin-screen.component.html',
    styleUrls: ['./news-list-admin-screen.component.css'],
})
export class NewsListAdminScreenComponent implements OnInit {
    newsList: any = [];
    fileToUpload: File;
    totalRecords: number;
    page: number = 1;
